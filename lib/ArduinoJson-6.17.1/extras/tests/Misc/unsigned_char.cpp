...
REQUIRE(n
== 13);
REQUIRE(memcmp(buffer, "\x81\xA5hello\xA5world", 13)
== 0);
}
...
REQUIRE(n
== 17);
REQUIRE(memcmp(buffer, "{\"hello\":\"world\"}", n)
== 0);
}
