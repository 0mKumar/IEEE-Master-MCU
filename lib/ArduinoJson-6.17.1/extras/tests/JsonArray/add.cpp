...
array.
add(serialized(const_cast<char *>("{}"))
);
...
SECTION("should duplicate serialized(std::string)") {
array.
add(serialized(std::string("\0XX", 3))
);
