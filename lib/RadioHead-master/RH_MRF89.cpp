...
bool RH_MRF89::init() {
    ...
    spiWriteRegister(RH_MRF89_REG_11_PFCREG,
                     0x38);// 100kHz, recommended, but not used, see RH_MRF89_REG_12_SYNCREG OOK only?
...
//    spiWriteRegister(RH_MRF89_REG_14_RSTSREG, 0x00); // NO, read only
    ...
    spiWriteRegister(RH_MRF89_REG_1E_PKTCREG,
                     RH_MRF89_PKTLENF | RH_MRF89_PRESIZE_4 | RH_MRF89_WHITEON | RH_MRF89_CHKCRCEN |
                     RH_MRF89_ADDFIL_OFF);
    spiWriteRegister(RH_MRF89_REG_1F_FCRCREG,
                     0x00); // default (FIFO access in standby=write, clear FIFO on CRC mismatch)
