...
AsyncWebSocket::AsyncWebSocket(const String &url)
        : _url(url), _clients(LinkedList<AsyncWebSocketClient *>([](AsyncWebSocketClient *c) { delete c; })),
...
void
AsyncWebSocket::_handleEvent(AsyncWebSocketClient *client, AwsEventType type, void *arg, uint8_t *data, size_t len) {
