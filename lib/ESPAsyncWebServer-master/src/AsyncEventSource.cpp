...
AsyncEventSourceClient::AsyncEventSourceClient(AsyncWebServerRequest *request, AsyncEventSource *server)
    ...
    _client->onTimeout([this](void *r, AsyncClient *c __attribute__((unused)),
                              uint32_t time) { ((AsyncEventSourceClient *) (r))->_onTimeout(time); }, this);
...
AsyncEventSource::AsyncEventSource(const String &url)
        : _url(url), _clients(LinkedList<AsyncEventSourceClient *>([](AsyncEventSourceClient *c) { delete c; })),
          _connectcb(NULL) {}
...
size_t
AsyncEventSourceResponse::_ack(AsyncWebServerRequest *request, size_t len, uint32_t time __attribute__((unused))) {
    if (len) {
